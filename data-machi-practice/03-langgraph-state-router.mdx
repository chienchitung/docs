...
### 步驟 1：確認 Repository、Branch 與最新 Commit
...
### 步驟 2：從 `main` 建立 Feature Branch

回到 Repository 首頁，點選 Branch 選擇器，輸入新 Branch 名稱，例如 `feature/add-sheets-tool`。確認新 Branch 是從最新的 `main` 建立後，再開始修改。
...
### 步驟 3：提交修改並建立 Pull Request

將修改提交到 Feature Branch，在 GitHub 建立 Pull Request，並填寫修改目的、影響範圍與測試方式。
...
### 步驟 4：在 Files changed 檢查 Diff

開啟 **Files changed**，逐一檢查新增與刪除內容。確認沒有 Secret、真實網址或企業資料後，再合併到 `main`。
