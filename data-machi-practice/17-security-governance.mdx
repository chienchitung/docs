...
## 檢查 GitHub Organization 與 Repository 權限

1. 進入公司 GitHub Organization 或 Repository Settings。
2. 開啟 People、Collaborators 或 Teams 權限頁面。
3. 確認 Repository 不只由單一個人帳號控制。
4. 至少安排一位備援管理者，並檢查每個角色是否符合最小權限。
5. 將 Repository 所有者、主要管理者與備援管理者記錄到資產清冊。
