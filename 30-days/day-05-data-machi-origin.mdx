...
<Frame>
  ![Data Machi 開發流程與正式產品架構](/assets/diagrams/day05-data-machi-architecture.svg "Data Machi 開發流程與正式產品架構")
</Frame>

<p align="center">
  *圖 1｜Data Machi 的開發流程與正式產品架構*
</p>
...
從這一天開始，我們會在 Day 05、10、15、20、25、30 累積六份設計成果，最後組成一份屬於你自己的 **Enterprise AI Blueprint**。這條主線不要求你複製 Data Machi，也不要求一開始就寫程式；Data Machi 只是一個用來理解架構如何落地的案例。

先選一段你熟悉、重複發生，而且需要在多個資訊來源之間切換的工作。不要從「我想做一個 Agent」開始，而要從「誰正在完成什麼工作」開始。

| 要定義的項目 | 引導問題 |
| --- | --- |
| 使用者 | 誰會使用這套企業 AI？ |
| 工作成果 | 他真正想完成的是什麼，而不只是想問什麼？ |
| 現行流程 | 現在如何 Find、Understand、Decide、Act、Track？ |
| 主要瓶頸 | 哪一步最耗時、最容易漏掉資訊或做錯判斷？ |
| AI 的角色 | AI 應協助搜尋、整理、判斷、執行，還是追蹤？ |
| 系統邊界 | 哪些事情不能交給 AI，或一定要人工確認？ |
| 第一版成功 | 最小版本只要完成哪一件事，就已經產生價值？ |

最後用一句話收斂：

> 我要為＿＿建立一套企業 AI，協助他們從＿＿取得資訊，完成＿＿；當＿＿發生時，系統必須停止、追問或交由人工處理。
